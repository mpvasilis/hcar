"""Entry point for the HCAR active constraint-acquisition experiments."""
import os
import pickle
import random
import sys
...
def active_learning_system(
    ...
    """Run the active constraint-acquisition loop and return learning statistics."""
...
def construct_instance(experiment_name):
    """Build the binary and global benchmark instances and oracles for the named experiment."""
...
def load_passive_learning_constraints(experiment_name, num_solutions=None, output_dir="output"):
    """Load previously pickled passive-learning constraints for the experiment, if present."""
...
if __name__ == "__main__":
    ...
    (valid_constraints, invalid_constraints,
        ...
        use_standard_pqgen=use_standard_pqgen, global_timeout=global_timeout,
