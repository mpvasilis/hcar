"""Binary encoding of the 'exam_timetabling' constraint-acquisition benchmark."""
import cpmpy as cp
...
def day_of_exam(course, slots_per_day):
    """Return the exam day index for a given course slot."""
...
def construct_examtt_simple(nsemesters=9, courses_per_semester=6, slots_per_day=9, days_for_exams=14):
    """Build the exam timetabling ProblemInstance and its ConstraintOracle."""
