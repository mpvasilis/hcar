"""Extracts structural feature dictionaries from CPMpy constraints for the constraint-classification model."""
...
def extract_constraint_features(constraint, all_variables, all_constraints=None):
    """Return a feature dict describing the type, arity, and index structure of a constraint."""
    features = {}
