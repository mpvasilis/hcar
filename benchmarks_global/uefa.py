"""Global-constraint encoding of the UEFA group-draw benchmark."""
import cpmpy as cp
import numpy as np
...
def construct_uefa(teams_data, n_groups=8, teams_per_group=4):
    """Build the UEFA group-draw ProblemInstance and ConstraintOracle from teams data."""
    parameters = {
        "n_groups": n_groups,
...
def generate_uefa_instance(instance_params=None):
    """Generate synthetic UEFA teams data and return the constructed instance and oracle."""
